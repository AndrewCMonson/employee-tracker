...
const updateManager = (callback) => {
    inquirer
        .prompt([
            ...
            db.query(sql, [response.manager_id, response.employee_id], (err, rows) => {
                if (err) {
                    console.log(err);
                    return;
                }
...
const viewEmployeeByManager = (callback) => {
    inquirer
        .prompt([
            {
                name: 'manager_id',
            ...
            db.query(sql, response.manager_id, (err, rows) => {
                if (err) {
                    console.log(err);
                    return;
                }
...
const deleteDepartment = (callback) => {
    inquirer
        .prompt([
            {
                name: 'department_id',
...
const deleteRole = (callback) => {
    inquirer
        .prompt([
            ...
            db.query(sql, response.role_id, (err, rows) => {
                if (err) {
                    console.log(err);
                    return;
                }
